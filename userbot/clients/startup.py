...
EOL = "EOL\nRpan-UserBot v{}, Copyright © 2021-2022 RevanAbi• <https://github.com/kuinginngopi>"
MSG_BLACKLIST = "MAKANYA GA USAH BERTINGKAH GOBLOK, USERBOT {} GUA MATIIN NAJIS BANGET DIPAKE JAMET KEK LU.\nRpan-UserBot v{}, Copyright © 2021-2022 DivaArvian• <https://github.com/kuinginngopi>"
...
def multiman():
    if 5014405611 not in DEVS:
        LOGS.warning(EOL.format(version))
        sys.exit(1)
    if -1001473548283 not in GBL:
        LOGS.warning(EOL.format(version))
        sys.exit(1)
    if 5014405611 not in DEFAULT:
        LOGS.warning(EOL.format(version))
        sys.exit(1)
    failed = 0
    if STRING_SESSION:
